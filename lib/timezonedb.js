...
TimeZoneDB.prototype.getTimeZoneData = function(options, callback) {
    if((typeof options === "function") || (options instanceof Function)) {
        ...
        throw new Error("getTimeZoneData() must have callback function");
    }
    ...
    if((!options.lat || !options.lng) && !options.zone) {
        throw new Error("Either zone or lat and lng have to be set");
    }
    ...
    var request = http.get({
        ...
        response.on("end", function() {
            ...
            if(!(parsedResponse.message === "")) {
                callback(new Error(parsedResponse.message), null);
            } else {
...
/**
 * @public
 * @description Expose unchangeable instance of TimeZoneDB.
 * @param {String} apiKey - API key.
 * @returns {Object} - Unchangeable instance of TimeZoneDB.
 */

module.exports = function(apiKey) {
    return freeze(new TimeZoneDB(apiKey));
};